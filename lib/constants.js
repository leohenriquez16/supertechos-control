...
export const APP_VERSION = '8.19.9';
// v8.19.9: fix Caja Chica — "Ajuste manual" creado desde admin sumaba al
//   saldo en lugar de restar. Default era signo_ajuste=+1 (entrada).
//   Ahora ModalCrearGastoAdmin tiene un selector explícito:
//     − Resta del saldo (gasto sin factura) ← default
//     + Suma al saldo (entrada extra)
//   Y se pasa signoAjuste correcto al crear.
//   También: cambios visuales en el módulo Levantamientos —
//   nombre de área editable y placeholder, botón "Nuevo levantamiento".
