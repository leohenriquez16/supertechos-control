...
// Si ya existe una persona con ese teléfono, la actualiza (re-invitación).
export async function invitarMaestroAlApp({ nombre, telefono, invitadoPorId, pinTemporal = null, rolesExtra = [] }) {
  ...
  // Buscar si ya existe una persona con ese teléfono (en cualquiera de los formatos)
