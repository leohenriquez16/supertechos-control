...
export const APP_VERSION = '8.17.48';
// v8.17.48: copy más explícito en el modal de cerrar jornada: solo aparecen
//           los presentes hoy. Si una persona no asistió no recibe dieta
//           (no aparece en la lista → no se puede marcar).
// v8.17.47: ⚠️ CAMBIO DE MODELO — la dieta y el hospedaje son del EQUIPO, no
//           de cada persona individual. Al cerrar jornada las marcas se
//           debitan de la caja chica del MAESTRO (o supervisor si el maestro
//           no tiene caja) y se muestran TODOS los presentes (incluyendo
//           ayudantes) para marcar quién comió/durmió. El concepto del
//           movimiento incluye el nombre del team member para trazabilidad.
//           Helper obtenerResponsableCajaDieta() encapsula la lógica.
//           Manual de dieta actualizado.
