...
function toCSV(facturas, catPorId = {}, maps = {}) {
  const { resolverAnalitica, resolverProducto, resolverProductoSimilar, resolverProveedor, cuentasProducto = {}, cuentaDefault = {}, sin } = maps;
  const headers = [
...
export async function generarZipFacturasOdoo({ facturas, categorias = [], cuentasAnaliticas = [], productos = [], proveedores = [], cuentasProducto = {}, cuentaDefault = {}, onProgreso }) {
