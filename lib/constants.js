...
export const APP_VERSION = '8.27.14';
// v8.27.14: [Proyectos · Lista] Fix warning de hidratación de React en la vista Lista.
//     El header de la tabla (VistaLista) tenía un espacio entre `<th />` y el comentario
//     `{/* color band */}`, lo que generaba un nodo de texto en blanco como hijo directo
//     de `<tr>` ("whitespace text nodes cannot be a child of <tr>"). Se eliminó el espacio.
//     Solo limpia la consola; no cambia la UI.
