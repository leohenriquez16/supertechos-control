...
// v8.50.0: [Vehículos · ficha y selector] (1) Al hacer clic en CUALQUIER parte del card
//     del vehículo abre su ficha completa (antes solo el nombre); los botones internos
//     (editar, GPS, docs, copiar) no la disparan. (2) Selector arriba para elegir un
//     vehículo (abre su ficha y filtra la lista) o "ver todos". (3) Modal de edición ya
//     no se corta arriba (items-start + scroll) y es más ancho (max-w-2xl); la ficha
//     también alinea arriba para no cortarse en pantallas altas.
