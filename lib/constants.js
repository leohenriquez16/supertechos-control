...
export const APP_VERSION = '8.17.51';
// v8.17.51: buscador en el selector de personal del modal Reservar de
//           Propiedades. Filtra por nombre o rol. Botones para Limpiar
//           selección y X para limpiar la búsqueda.
// v8.17.50: modal Reservar de Propiedades usa ProyectoSelector (con buscador)
//           en lugar de un <select> nativo, que con muchos proyectos era
//           difícil de navegar.
