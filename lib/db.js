...
// Mantiene la misma firma y mensaje de error genérico que la versión
// previa. La validación, comparación y lazy re-hash se hacen en
// /api/auth/login (ver route.js).
