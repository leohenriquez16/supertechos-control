...
export async function crearActaProyecto({ tipo, proyectoId, areaId = null, empresa = null, garantiaId = null, garantiaInicio = null, garantiaFin = null, garantiaAnios = null, cliente, snapshotDatos, generadaPorId, docusealValues = {} }) {
  const res = await fetch('/api/actas/crear', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      tipo, proyectoId, areaId, empresa, garantiaId, garantiaInicio, garantiaFin, garantiaAnios,
