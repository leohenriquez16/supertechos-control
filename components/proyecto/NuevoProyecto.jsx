...
export default function NuevoProyecto({ personal, sistemas, clientes = [], contactos = [], proyectos = [], onCancelar, onCrear }) {
  ...
  const [form, setForm] = useState({
    ...
    contactosExtraIds: [], // v8.17.58: contactos adicionales al principal
  ...
  const procesarPDF = async (file) => {
    ...
    try {
      ...
      setForm({
        ...
        // v8.10.22: NO autocompletar fecha_inicio del PDF — esa es la fecha del PDF, no la de inicio real
        // fecha_inicio queda vacío (admin la define cuando arranque el trabajo)
        areas: areasDelForm,
