...
Responde ÚNICAMENTE con un objeto JSON válido, sin texto adicional, sin markdown fences.
{
  ...
  // v8.17.72: el endpoint ahora hace streaming (texto plano con los text_delta
  // concatenados). Leemos el body completo y al final parseamos como JSON.
  // El streaming evita 504 del gateway de Vercel cuando la generación es lenta.
