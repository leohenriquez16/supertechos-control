...
export function exportarPagosOdooCSV({ movimientos, data }) {
  ...
  const rows = aprobados.map(m => {
    ...
    return {
      ...
      sin_factura: m.datosIA?.sin_factura ? 'true' : 'false',
...
// ============================================================
// Solo gastos_factura aprobados que SÍ tengan factura (no informales).
// Cuenta analítica = referencia Odoo del proyecto si está asociado.
