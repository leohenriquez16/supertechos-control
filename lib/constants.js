...
export const APP_VERSION = '8.17.83';
...
//   - Visible en 3 lugares:
//     * Modal Entregar Caja Chica: aparece tras seleccionar persona, con el
//       monto que se está por entregar como base para el proporcional.
//     * Vista Por Persona expandida: muestra desglose siempre; si saldo es
//       negativo, propone el monto a reponer y cómo se reparte.
//     * PDF de cuadre: sección "Reembolso por empresa" después de "Egresos
//       por categoría", con tabla bruto + (si saldo final negativo) aporte
//       proporcional al reembolso necesario.
