...
import { ArrowLeft, Loader2, Plus, Wallet, AlertCircle, Eye, Check, X, Trash2, FileText, Filter } from 'lucide-react';
...
export default function VistaCajaChicaAdmin({ usuario, data, onVolver }) {
