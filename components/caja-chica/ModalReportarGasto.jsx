...
import { Camera, Loader2, X, Sparkles, AlertTriangle, Check, MessageSquare } from 'lucide-react';
  ...
  const guardar = async () => {
    ...
    try {
      await db.crearMovimientoCajaChica({
        ...
        tipo: 'gasto_factura',
        monto,
        // El helper sube la foto al bucket y guarda foto_path. Si sinFoto=true no se manda nada.
        fotoDataUrl: sinFoto ? null : fotoData,
        ...
        {paso === 'confirmar' && (
          <div className="space-y-3">
            ...
            <div className="flex gap-2 pt-2 border-t border-zinc-800">
              ...
              <button
                onClick={guardar}
                disabled={!datos.monto || (!fotoData && !sinFoto)}
