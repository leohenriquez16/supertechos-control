...
// ============================================================
// v8.19.94: comprime a Blob (para subir a Storage, no base64). Mantiene buena
// calidad para fotos técnicas de levantamiento pero reduce el tamaño.
export function comprimirImagenABlob(file, maxWidth = 1600, quality = 0.7) {
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        ...
        canvas.toBlob((blob) => blob ? resolve(blob) : reject(new Error('toBlob devolvió null')), 'image/jpeg', quality);
      };
      img.onerror = reject;
