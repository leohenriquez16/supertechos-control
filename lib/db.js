...
function viajeRowToObj(v) {
  return {
    ...
    vehiculo: v.vehiculo || '', tipoEnvio: v.tipo_envio || 'camion', estado: v.estado,
...
export async function listarViajes({ fecha = null, desde = null, hasta = null, choferId = null } = {}) {
...
export async function crearViaje({ fecha, choferId, choferNombre, vehiculo, tipoEnvio, notas, creadoPorId }) {
  ...
  const { error } = await supabase.from('viajes').insert({
    ...
    vehiculo: vehiculo || null, tipo_envio: tipoEnvio || 'camion', notas: notas || null,
