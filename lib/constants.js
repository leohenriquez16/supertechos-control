...
export const APP_VERSION = '8.17.40';
// v8.17.40: 🐛 AI factura — la IA estaba poniendo a Super Techos / Prouco como
//           proveedor en algunas facturas (cuando los datos del receptor estaban
//           pegados arriba del documento). Una empresa no se vende a sí misma:
//           fortalecido el prompt con regla dura + post-proceso defensivo que
//           detecta y swappea si la IA aún se equivoca.
