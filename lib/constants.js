...
export const APP_VERSION = '8.19.90';
// v8.19.90: borrado de levantamientos con autorización del owner. Solo el dueño
//     (levantador asignado) puede eliminar; si un admin quiere borrar, deja una
//     solicitud y el owner la autoriza (o rechaza). Sin owner asignado, el admin
//     puede borrar directo. Migración 055 + helpers + UI en el detalle del sitio.
