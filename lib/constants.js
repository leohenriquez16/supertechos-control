...
export const APP_VERSION = '8.17.77';
// v8.17.77: Fix definitivo del hover-card del Kanban — React portal a body.
//   - El position:fixed del PR anterior no escapaba del clipping cuando algún
//     ancestro creaba stacking context. Solución correcta: renderizar la
//     tooltip con createPortal directo a document.body, fuera del árbol del
//     kanban. Ahora no la puede tapar nada.
