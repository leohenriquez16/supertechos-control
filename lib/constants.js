...
// v8.27.21: [Entrega/DocuSeal Fase 3] Automatización: al FIRMAR el acta de entrega,
//     el proyecto pasa a 'recibido conforme' y se avisa por correo a admins para
//     facturar (webhook). Cron garantias-por-factura: revisa en Odoo si la factura
//     está saldada y, al estarlo, emite la carta de garantía automático. Requiere
//     CRON_SECRET en Vercel. (Fase 1 multi-área + Fase 2 garantía por área incluidas.)
// v8.27.19: [Entrega/DocuSeal] Pestaña "Entrega" en el proyecto: actas de entrega
//     (proyecto completo o por área/edificio) firmadas por el cliente vía DocuSeal.
//     Cliente recibe link por email o WhatsApp, firma en su celular, queda el PDF.
//     Backend: lib/docuseal.js, /api/actas/crear, /api/docuseal/webhook, tabla
//     actas_proyecto (+ carta_garantia por empresa). Requiere env DOCUSEAL_* y
//     plantillas en DocuSeal Cloud. Migración pendiente de aplicar a prod.
