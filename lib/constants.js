...
export const APP_VERSION = '8.19.64';
// v8.19.64: fix modal "Entregar caja chica" — no cabía en pantalla ni scrolleaba con
//     el comprobante bancario (IA). Ahora max-h 92vh + overflow-y-auto y encabezado
//     sticky (la X de cerrar queda visible al scrollear).
