...
const SELECT_CAJA = 'id, persona_id, proyecto_id, fecha, tipo, monto, signo_ajuste, foto_path, proveedor, rnc, concepto, datos_ia, status, motivo_rechazo, aprobado_por_id, aprobado_at, creado_por_id, created_at, rotacion_grados';
